 ...
 */
exports.asyncAppend = function (value, mapper) {
    return lit_html_js_1.directive(function (part) { return __awaiter(_this, void 0, void 0, function () {
        var e_1, _a, itemPart, i, value_1, value_1_1, v, itemStartNode, e_1_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    itemPart = new lit_html_js_1.NodePart(part.instance, itemStartNode, part.endNode);
                    itemPart.setValue(v);
                    i++;
                    _b.label = 4;
